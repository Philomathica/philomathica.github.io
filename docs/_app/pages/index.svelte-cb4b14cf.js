import{S as l,i as o,s as c,e as r,a as d,c as n,n as e,f as p}from"../chunks/index-350455f2.js";function g(i){let t;return{c(){t=r("div"),t.innerHTML=`<header><nav class="bg-slate-800"><div class="container flex items-center px-4 py-4 mx-auto"><a href="#main" class="flex items-center text-blue-200 hover:text-blue-400"><span class="w-5 h-5"><svg viewBox="0 0 185 205" xmlns="http://www.w3.org/2000/svg"><path fill="currentcolor" fill-rule="evenodd" clip-rule="evenodd" d="M185 92.5C185 143.586 143.586 185 92.5 185C71.6763 185 52.4597 178.119 37 166.507V186.5C37 196.717 28.7173 205 18.5 205H0V94H0.0119162C0.00398204 93.501 0 93.0009 0 92.5C0 41.4137 41.4137 0 92.5 0C143.586 0 185 41.4137 185 92.5ZM145 92.5C145 121.495 121.495 145 92.5 145C63.5051 145 40 121.495 40 92.5C40 63.5051 63.5051 40 92.5 40C121.495 40 145 63.5051 145 92.5Z"></path></svg></span> 
    ...
    <section id="hero" class="h-[60vh] flex items-center bg-blue-800 bg-gradient-to-t from-slate-900 to-slate-800"><div class="container px-4 mx-auto text-white"><h1 class="text-4xl md:text-5xl uppercase tracking-wider">Your partner <br/> in design &amp; development</h1> 
        <h2 class="font-thin normal-case tracking-wider text-white">- We create apps and websites your clients will love!</h2> 
        <a class="inline-block px-8 py-3 mt-6 tracking-wide text-white bg-blue-500 rounded-md font-narrow hover:bg-blue-700" href="#contact">Let&#39;s Get Started!</a></div></section></header> 
  ...
  <main id="main" class="container px-4 mx-auto"><section id="offering" class="py-8 md:py-16"><h2 class="text-xl text-gray-900 normal-case md:text-3xl">What we&#39;re offering</h2> 
      ...
      <div class="grid grid-cols-1 gap-12 mt-8 md:grid-cols-3"><div class="flex flex-col items-center px-8 py-12 bg-white rounded-lg drop-shadow-xl"><img class="m-auto" width="160" height="160" src="/images/design.svg" alt="design"/> 
          <h4 class="text-blue-500 font-bold uppercase tracking-widest">Design</h4> 
          <p class="mt-3 text-sm text-gray-600 h-10">Product design, UI/UX design, Design systems.</p></div> 
        <div class="flex flex-col items-center px-8 py-12 bg-white rounded-lg drop-shadow-xl"><img class="m-auto" width="160" height="160" src="/images/development.svg" alt="development"/> 
          <h4 class="text-blue-500 font-bold uppercase tracking-widest">Development</h4> 
          <p class="mt-3 text-sm text-gray-600 h-10">Developing scalable web apps and mobile apps.</p></div> 
        <div class="flex flex-col items-center px-8 py-12 bg-white rounded-lg drop-shadow-xl"><img class="m-auto" width="160" height="160" src="/images/deployment.svg" alt="deployment"/> 
    ...
    <section id="team" class="py-8 md:py-16"><h2 class="normal-case md:text-3xl">The team</h2> 
      ...
      <div class="flex p-16 my-12 bg-white rounded-lg drop-shadow-xl"><img class="w-48 h-48 rounded-full mr-6 bg-gray-200" src="/avatar-white.png" alt="Luuk Moret"/> 
        <div class="ml-8 text-gray-700 border-l pl-14"><h3 class="text-3xl uppercase">Luuk Moret</h3> 
          ...
          <div class="flex flex-wrap gap-4"><a href="https://github.com/LuukMoret"><img width="32" height="32" src="/icons/twitter.svg" alt="twitter"/></a> 
      ...
      <div class="flex p-16 my-12 bg-white rounded-lg drop-shadow-xl"><img class="w-48 h-48 rounded-full mr-6" src="/images/avatar-joris.jpeg" alt=""/> 
        <div class="ml-8 text-gray-700 border-l pl-14"><h3 class="text-3xl uppercase">Joris Compernol</h3> 
          <ul class="text-gray-500 mt-2"><li>UI/UX designer, Front-end developer, data-viz</li> 
            <li>Lead experience</li></ul> 
          <h4 class="mt-8 mb-4 text-gray-400 font-medium text-xs uppercase tracking-widest">Links</h4> 
          <div class="flex flex-wrap gap-4"><a href="https://github.com/compernoljoris"><img width="32" height="32" src="/icons/twitter.svg" alt="twitter"/></a> 
            <a href="https://twitter.com/compernoljoris"><img width="32" height="32" src="/icons/github.svg" alt="github"/></a> 
      ...
      <div class="flex p-16 my-12 bg-white rounded-lg drop-shadow-xl"><img class="w-48 h-48 rounded-full mr-6 bg-gray-200" src="/avatar-white.png" alt=""/> 
        <div class="ml-8 text-gray-700 border-l pl-14"><h3 class="text-3xl uppercase">Robby Pelssers</h3> 
          <ul class="text-gray-500 mt-2"><li>Full stack developer (Java / NodeJs / Typescript / Angular)</li> 
            <li>Lead experience</li></ul> 
          <h4 class="mt-8 mb-4 text-gray-400 font-medium text-xs uppercase tracking-widest">Links</h4> 
          <div class="flex flex-wrap gap-4"><a href="https://github.com/pelssersconsultancy" target="_blank"><img width="32" height="32" src="/icons/twitter.svg" alt="twitter"/></a> 
          ...
          <div class="flex flex-wrap gap-4"><div class="tooltip" data-tip="tailwindcss"><img class="w-10 h-10" src="/icons/tailwindcss.svg" alt="tailwindcss"/></div> 
            ...
            <div class="tooltip" data-tip="Angular"><img class="w-10 h-10" src="/icons/angular.svg" alt="angular"/></div> 
            <div class="tooltip" data-tip="Nest"><img class="w-10 h-10" src="/icons/nest.svg" alt="nest"/></div> 
            <div class="tooltip" data-tip="Mongodb"><img class="w-10 h-10" src="/icons/mongodb.svg" alt="mongodb"/></div></div></div></div></section> 

    

    <section id="contact" class="py-8 md:py-16 text-center"><h2 class="md:text-3xl">Start your project with philomatica</h2> 
      ...
      <a href="mailto:philomaticateam@gmail.com" class="inline-block px-8 py-3 mt-8 tracking-wide text-white bg-blue-500 rounded-md font-narrow hover:bg-blue-700">Send us an Email</a></section></main> 

  <footer class="py-8 bg-gray-800 md:py-16"><div class="container px-4 mx-auto text-xs font-thin text-center text-white">philomatica design and development team Begium, The Netherlands - philomaticateam@gmail.com Copyright \xA9 2022 - All rights reserved</div></footer>`,d(t,"class","font-sans bg-gray-100")},m(s,a){n(s,t,a)},p:e,i:e,o:e,d(s){s&&p(t)}}}class h extends l{constructor(t){super(),o(this,t,null,g,c,{})}}export{h as default};
