...
function Ke(n) {
  ...
  return {
    ...
    p(r, l) {
      r[5] ? (t ? t.p(r, l) : ((t = Be(r)), t.c(), t.m(e, null))) : t && (t.d(1), (t = null));
    },
    d(r) {
      r && z(e), t && t.d();
    },
...
const $t = 'modulepreload',
  ...
  Re = [
    () =>
      ye(
        () => import('./pages/__layout.svelte-f92ee66b.js'),
        ['pages/__layout.svelte-f92ee66b.js', 'assets/pages/__layout.svelte-212febce.css', 'chunks/index-04d870dc.js'],
      ),
    () => ye(() => import('./error.svelte-738afb7d.js'), ['error.svelte-738afb7d.js', 'chunks/index-04d870dc.js']),
    () => ye(() => import('./pages/index.svelte-59f7507b.js'), ['pages/index.svelte-59f7507b.js', 'chunks/index-04d870dc.js']),
  ],
  St = { '': [[0, 2], [1]] };
function Ye(n) {
...
function It({ target: n, session: e, base: t, trailing_slash: r }) {
  ...
  f.session.subscribe(async c => {
    ...
    (Ue = !0);
  let X = !0,
    T = (Ce = history.state) == null ? void 0 : Ce[B];
  T || ((T = Date.now()), history.replaceState(se(P({}, history.state), { [B]: T }), '', location.href));
  const de = re[T];
  ...
  async function _e(c, p, w, u) {
    ...
    if (((y = !0), u && u.details)) {
      const { details: $ } = u,
        E = $.replaceState ? 0 : 1;
      ($.state[B] = T += E), history[$.replaceState ? 'replaceState' : 'pushState']($.state, '', c);
    }
    ...
    e: for (let L = 0; L < b.length; L += 1) {
      ...
      try {
        ...
        if (
          ...
          Array.from(I.uses.dependencies).some(W => a.some(le => le(W))) ||
          ($ && I.uses.stuff)
        ) {
          let W = {};
          ...
          if ((m || (N = await Q({ module: x, url: p, params: w, props: W, stuff: S, routeId: u.id })), N && (le && (N.uses.url = !0), N.loaded))) {
    ...
    _start_router: () => {
      ...
      addEventListener('touchstart', c),
        ...
        addEventListener('hashchange', () => {
          pe && ((pe = !1), history.replaceState(se(P({}, history.state), { [B]: ++T }), '', location.href));
        });
    },
